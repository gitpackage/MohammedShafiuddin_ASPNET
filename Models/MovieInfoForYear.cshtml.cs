...
{
    public class MovieInfoForYearModel : PageModel
    {
        ...
        public void OnGet(string input)
        {
            ...
            try
            {
                ...
                else if (!(int.TryParse(input.ToString(), out temp)))
                         {
                         throw new Exception("please enter release year");
                         }
